...
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&c(e,t)})(d,Ember.Application)
var n,o=(n=d,function(){var e,t=f(n)
...
var t,a,f,c,s=(t=d,function(){var e,n=l(t)
if(i()){var r=l(this).constructor
e=Reflect.construct(n,arguments,r)}else e=n.apply(this,arguments)
return o(this,e)})
function d(){return n(this,d),s.apply(this,arguments)}return a=d,(f=[{key:"beforeModel",value:function(){this.transitionTo("signin")}}])&&r(a.prototype,f),c&&r(a,c),d}()
...
return Object.defineProperty(n,"__esModule",{value:!0}),n}catch(r){throw new Error('Could not read config from meta tag with name "'+e+'".')}})),runningTests||require("ember-styled-component-login/app").default.create({name:"ember-styled-component-login",version:"0.0.0+9a4cd994"})
