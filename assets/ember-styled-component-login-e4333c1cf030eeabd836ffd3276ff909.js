...
return Object.defineProperty(n,"__esModule",{value:!0}),n}catch(o){throw new Error('Could not read config from meta tag with name "'+e+'".')}})),runningTests||require("ember-styled-component-login/app").default.create({name:"ember-styled-component-login",version:"0.0.0+efccc0f8"})
